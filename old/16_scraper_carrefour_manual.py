"""
SCRAPER CARREFOUR - VERSIÓN SEMI-MANUAL
...
def capturar_productos():
    ...
    with sync_playwright() as p:
        ...
        print("="*70)
        print("SCRAPER CARREFOUR - SEMI MANUAL")
        print("="*70)
        print("\nINSTRUCCIONES:")
        print("1. Voy a abrir el navegador")
        print("2. Tú navegas a Carrefour y buscas lo que quieras")
        ...
        while True:
            continuar = input("\nNavega a una categoría y presiona Enter para capturar (o escribe 'salir'): ")
            ...
            for selector in ['.product-card', '[class*="product"]', 'article', '.product']:
                try:
...
if __name__ == "__main__":
    print("\n⚠️  SCRAPER SEMI-MANUAL CARREFOUR:")
